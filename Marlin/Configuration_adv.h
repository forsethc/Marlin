 ...
 */
#define USE_CONTROLLER_FAN // Noctua 80mm FLX
 ...
 */
#define E0_AUTO_FAN_PIN PB6  // Noctua 4020 FLX
...
// #define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  26.06          // (Hz) The default dominant resonant frequency on the X axis.
...
#define BABYSTEPPING  // Ender Configs
  ...
  #define BABYSTEP_MULTIPLICATOR_Z  0.025       // (steps or mm) Steps or millimeter distance for each Z babystep  // Ender Configs
